        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Crs_Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Crs_Code = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Crs_Catogery = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Crs_Cover_Path = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Course_Students", x => new { x.Student_ID, x.Course_ID, x.Code_ID });
                    table.ForeignKey(
                        name: "FK_Course_Students_Codes_Code_ID",
                        column: x => x.Code_ID,
                        principalTable: "Codes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Course_Students_Course_Course_ID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Course_Students_Code_ID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Instructors_ApplicationUser_Id",
                table: "Instructors",
                column: "ApplicationUser_Id",
                unique: true,
                filter: "[ApplicationUser_Id] IS NOT NULL");
